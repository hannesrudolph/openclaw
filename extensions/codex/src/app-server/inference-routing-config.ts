...
export type CodexInferenceProviderKind = "openai" | "azure" | "other";

export function responsesOAuthProvider(route: CodexInferenceProxy): JsonObject {
  return {
...
export function providerKind(name: unknown): CodexInferenceProviderKind | undefined {
